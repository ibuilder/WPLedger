...
class ComposerStaticInit58beaa193728f6afa2cd8fa9b717016b
{
    public static $files = array (
        ...
        '60d092f37a8b0636e7b26965ece34d10' => __DIR__ . '/../..' . '/includes/rest/trait-rest-helpers.php',
    );
    ...
    public static $classMap = array (
        ...
        'WPLedger\\Activator' => __DIR__ . '/../..' . '/includes/class-activator.php',
        'WPLedger\\Admin\\AdminMenu' => __DIR__ . '/../..' . '/includes/admin/class-admin-menu.php',
        'WPLedger\\Db\\Schema' => __DIR__ . '/../..' . '/includes/db/class-schema.php',
        'WPLedger\\Deactivator' => __DIR__ . '/../..' . '/includes/class-deactivator.php',
        'WPLedger\\Export\\QbExporter' => __DIR__ . '/../..' . '/includes/export/class-qb-exporter.php',
        'WPLedger\\Integrations\\WcInvoice' => __DIR__ . '/../..' . '/includes/integrations/class-wc-invoice.php',
        'WPLedger\\Integrations\\WoocommerceSync' => __DIR__ . '/../..' . '/includes/integrations/class-woocommerce-sync.php',
        'WPLedger\\Models\\Coa' => __DIR__ . '/../..' . '/includes/models/class-coa.php',
        'WPLedger\\Pdf\\PdfRenderer' => __DIR__ . '/../..' . '/includes/pdf/class-pdf-renderer.php',
        'WPLedger\\Plugin' => __DIR__ . '/../..' . '/includes/class-plugin.php',
        'WPLedger\\Rest\\RestAuth' => __DIR__ . '/../..' . '/includes/rest/class-rest-auth.php',
        'WPLedger\\Rest\\RestCompanies' => __DIR__ . '/../..' . '/includes/rest/class-rest-companies.php',
        'WPLedger\\Rest\\RestHelpers' => __DIR__ . '/../..' . '/includes/rest/trait-rest-helpers.php',
        'WPLedger\\Rest\\RestIntegrations' => __DIR__ . '/../..' . '/includes/rest/class-rest-integrations.php',
        'WPLedger\\Rest\\RestJournal' => __DIR__ . '/../..' . '/includes/rest/class-rest-journal.php',
        'WPLedger\\Rest\\RestReports' => __DIR__ . '/../..' . '/includes/rest/class-rest-reports.php',
        'WPLedger\\Services\\Ledger' => __DIR__ . '/../..' . '/includes/services/class-ledger.php',
        'WPLedger\\Services\\LedgerException' => __DIR__ . '/../..' . '/includes/services/class-ledger.php',
        'WPLedger\\Services\\Statements' => __DIR__ . '/../..' . '/includes/services/class-statements.php',
    );

    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->prefixLengthsPsr4 = ComposerStaticInit58beaa193728f6afa2cd8fa9b717016b::$prefixLengthsPsr4;
            $loader->prefixDirsPsr4 = ComposerStaticInit58beaa193728f6afa2cd8fa9b717016b::$prefixDirsPsr4;
            $loader->classMap = ComposerStaticInit58beaa193728f6afa2cd8fa9b717016b::$classMap;
